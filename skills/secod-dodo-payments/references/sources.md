...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DODO-PAYMENTS-SRC-01 | API authentication | https://docs.dodopayments.com/api-reference/introduction | Dodo Payments | 2026-09-05 (identification only) | 2027-03-05 or documentation/service behavior change | Pending review | PROVISIONAL-dodo-payments-ALL | Current hosted service; exact plan, region, API/SDK version, enabled features, and deployed configuration must be verified per project. |
| DODO-PAYMENTS-SRC-02 | Webhook security | https://docs.dodopayments.com/developer-resources/webhooks | Dodo Payments | 2026-09-05 (identification only) | 2027-03-05 or documentation/service behavior change | Pending review | PROVISIONAL-dodo-payments-ALL | Current hosted service; exact plan, region, API/SDK version, enabled features, and deployed configuration must be verified per project. |
