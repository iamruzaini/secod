...
description: >-
  Help coding agents securely implement Lemon Squeezy features using version-matched official APIs, secure defaults, and provider-specific tests. Use when Lemon Squeezy checkout, variants, subscriptions, license keys, API, or webhooks.
license: Apache-2.0
metadata:
...
# Secure Lemon Squeezy implementation

## Purpose

Implement Lemon Squeezy features securely. Provider-family router supplies shared context; this skill owns exact product decisions and version-qualified SDK/runtime use.

## When to use

Use when Lemon Squeezy checkout, variants, subscriptions, license keys, API, or webhooks. Do not activate from package presence alone when current feature does not use Lemon Squeezy.
