...
description: >-
  Help coding agents implement provider-independent payment, subscription, refund, and entitlement invariants under retries, duplicates, and delayed events.
license: Apache-2.0
metadata:
...
# Correct payment and entitlement implementation

## Purpose

Own portable security invariants for correct payment and entitlement implementation. Provider and framework adapters own exact SDK calls and deployment controls.

## When to use

Use for checkout, billing, subscriptions, invoices, refunds, credits, entitlements, discounts, payment webhooks, or reconciliation. Do not activate for unrelated documentation or presentation-only changes.
