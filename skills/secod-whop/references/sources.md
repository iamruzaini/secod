...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| WHOP-SRC-01 | API authentication | https://dev.whop.com/api-reference/authentication | Whop | 2026-09-05 (identification only) | 2027-03-05 or documentation/service behavior change | Pending review | PROVISIONAL-whop-ALL | Current hosted service; exact plan, region, API/SDK version, enabled features, and deployed configuration must be verified per project. |
| WHOP-SRC-02 | Webhook overview | https://dev.whop.com/api-reference/v5/webhooks/overview | Whop | 2026-09-05 (identification only) | 2027-03-05 or documentation/service behavior change | Pending review | PROVISIONAL-whop-ALL | Current hosted service; exact plan, region, API/SDK version, enabled features, and deployed configuration must be verified per project. |
