...
description: >-
  Help coding agents implement authorized uploads, downloads, object storage, exports, and file processing with content validation and bounded resource use.
license: Apache-2.0
metadata:
...
# Secure data and file handling

## Purpose

Own portable security invariants for secure data and file handling. Provider and framework adapters own exact SDK calls and deployment controls.

## When to use

Use for uploads, downloads, object storage, attachments, media processing, archives, exports, imports, or share links. Do not activate for unrelated documentation or presentation-only changes.
