...
description: >-
  Help coding agents securely implement Vercel AI SDK features using version-matched official APIs, secure defaults, and provider-specific tests. Use when Vercel AI SDK, AI Gateway, generateText/streamText, tools, provider packages, or model routing.
license: Apache-2.0
metadata:
...
# Secure Vercel AI SDK implementation

## Purpose

Implement Vercel AI SDK features securely. Provider-family router supplies shared context; this skill owns exact product decisions and version-qualified SDK/runtime use.

## When to use

Use when Vercel AI SDK, AI Gateway, generateText/streamText, tools, provider packages, or model routing. Do not activate from package presence alone when current feature does not use Vercel AI SDK.
...
- Keep credentials server-side, validate tools/output, authorize effects, constrain model routing, and protect streamed tenant data.
