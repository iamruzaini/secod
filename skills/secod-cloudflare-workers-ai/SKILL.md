...
description: >-
  Help coding agents securely implement Cloudflare Workers AI features using version-matched official APIs, secure defaults, and provider-specific tests. Use when Workers AI bindings, AI.run, models, embeddings, streaming, or Workers AI REST calls.
license: Apache-2.0
metadata:
...
# Secure Cloudflare Workers AI implementation

## Purpose

Implement Cloudflare Workers AI features securely. Provider-family router supplies shared context; this skill owns exact product decisions and version-qualified SDK/runtime use.

## When to use

Use when Workers AI bindings, AI.run, models, embeddings, streaming, or Workers AI REST calls. Do not activate from package presence alone when current feature does not use Cloudflare Workers AI.
