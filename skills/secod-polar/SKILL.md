...
name: secod-polar
description: >-
  Help coding agents securely implement Polar features using version-matched official APIs, secure defaults, and provider-specific tests. Use when Polar checkout, products, subscriptions, benefits, customer portal, API, or webhooks.
license: Apache-2.0
metadata:
...
# Secure Polar implementation

## Purpose

Implement Polar features securely. Provider-family router supplies shared context; this skill owns exact product decisions and version-qualified SDK/runtime use.

## When to use

Use when Polar checkout, products, subscriptions, benefits, customer portal, API, or webhooks. Do not activate from package presence alone when current feature does not use Polar.
